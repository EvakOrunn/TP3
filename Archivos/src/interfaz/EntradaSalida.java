...
public class EntradaSalida {
    ...
    public static Integer leerInteger() {
        while (true) {
            try {
                ...
                EntradaSalida.emitirMensaje("No es un entero. Por favor, pruebe otra vez!");
            }
        }
    }
    ...
    public static void mostrarInteger(String mensaje, Integer valor) {
        EntradaSalida.emitirMensaje(mensaje + valor);
    }
    ...
    public static float leerFloat() {
        while (true) {
            try {
                ...
                EntradaSalida.emitirMensaje("No es un float. Por favor, pruebe otra vez!");
            }
        }
    }
    ...
    public static String leerDatoString() {
        while (true) {
            try {
                ...
                EntradaSalida.emitirMensaje("No es un String. Por favor, pruebe otra vez!");
            }
        }
    }
    ...
    public static char leerChar() {
        while (true) {
            try {
                ...
                EntradaSalida.emitirMensaje("No es un integer. Por favor, pruebe otra vez!");
            }
        }
    }
