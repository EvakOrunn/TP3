...
public class Archivo {
     ...
     * @param reg
     */
    public void crearArchivoVacio(Register reg) {
     ...
     */
    public void grabarRegistro(Register r) {
     ...
     */
    public boolean altaRegistro(Register r) {
        boolean resp = false;

        if (r != null && (tipo.getClass() == r.getDatos().getClass())) {
            try {
                buscarRegistro(r.getNroOrden());
                Register x = leerRegistro();
                if (!x.getActivo()) {
                    grabarRegistro(r);
                } else {
     ...
     * @return true si fue posible agregar el registro - false si no fue posible
     */
    public void cargarUnRegistro(Register r) {
        abrirParaLeerEscribir();
        try {
            grabarRegistro(r);
        } catch (Exception e) {
     ...
     */
    public boolean bajaRegistro(Register r) {
        boolean resp = false;
     ...
     * posible
     */
    public boolean modificarRegistro(Register r) {
        boolean resp = false;
